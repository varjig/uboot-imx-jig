...
/* ENET0 connects to AR8033 on CPU board, ENET1 connects to to AR8033 on carrier board */
...
#define JAILHOUSE_ENV \
	"jh_mmcboot=" \
		"setenv fdt_file fsl-imx8qxp-var-som-root.dtb;"\
...
#define XEN_BOOT_ENV \
            "xenhyper_bootargs=console=dtuart dtuart=/serial@5a090000 dom0_mem=2048M dom0_max_vcpus=2 dom0_vcpus_pin=true\0" \
            "xenlinux_bootargs= \0" \
            "xenlinux_console=hvc0 earlycon=xen\0" \
            "xenlinux_addr=0x92000000\0" \
	    "dom0fdt_file=fsl-imx8qxp-var-som-dom0.dtb\0" \
            "xenboot_common=" \
