...
/*
 * Copyright (C) 2023-2025 Variscite Ltd.
 */
...
void var_eeprom_adjust_dram(struct var_eeprom *ep, struct dram_timing_info *d)
{
	...
	struct mx9_ddr_adjust mx9_adjust_table[] = {
		{ .name = "DDRC",
		  .cfg_param = d->ddrc_cfg,
		  .cfg_num = d->ddrc_cfg_num },
		{ .name = "DDR PHY",
		  .cfg_param = d->ddrphy_cfg,
		  .cfg_num = d->ddrphy_cfg_num },
		{ .name = "PIE",
		  .cfg_param = d->ddrphy_pie,
		  .cfg_num = d->ddrphy_pie_num },
		{ .name = "FSP_CFG[0].ddrc_cfg",
		  .cfg_param = d->fsp_cfg[0].ddrc_cfg,
		  .cfg_num =  ARRAY_SIZE(d->fsp_cfg[0].ddrc_cfg)},
		{ .name = "FSP_CFG[0].mr_cfg",
		  .cfg_param = d->fsp_cfg[0].mr_cfg,
		  .cfg_num =  ARRAY_SIZE(d->fsp_cfg[0].mr_cfg)},
		{ .name = "FSP_CFG[1].ddrc_cfg",
		  .cfg_param = d->fsp_cfg[1].ddrc_cfg,
		  .cfg_num =  ARRAY_SIZE(d->fsp_cfg[1].ddrc_cfg)},
		{ .name = "FSP_CFG[1].mr_cfg",
		  .cfg_param = d->fsp_cfg[1].mr_cfg,
		  .cfg_num =  ARRAY_SIZE(d->fsp_cfg[1].mr_cfg)},
		{ .name = "FSP_CFG[2].ddrc_cfg",
		  .cfg_param = d->fsp_cfg[2].ddrc_cfg,
		  .cfg_num =  ARRAY_SIZE(d->fsp_cfg[2].ddrc_cfg)},
		{ .name = "FSP_CFG[2].mr_cfg",
		  .cfg_param = d->fsp_cfg[2].mr_cfg,
		  .cfg_num =  ARRAY_SIZE(d->fsp_cfg[2].mr_cfg)},
		{ .name = "FSP0",
		  .cfg_param = d->fsp_msg[0].fsp_cfg,
		  .cfg_num = d->fsp_msg[0].fsp_cfg_num },
		{ .name = "FSP0 2D",
		  .cfg_param = d->fsp_msg[3].fsp_cfg,
		  .cfg_num = d->fsp_msg[3].fsp_cfg_num },
		{ .name = "FSP1",
		  .cfg_param = d->fsp_msg[1].fsp_cfg,
		  .cfg_num = d->fsp_msg[1].fsp_cfg_num },
		{ .name = "FSP2",
		  .cfg_param = d->fsp_msg[2].fsp_cfg,
		  .cfg_num = d->fsp_msg[2].fsp_cfg_num },
		{ .name = NULL },
	};
	...
	if (ddr_crc32 != ep->ddr_crc32) {
		printf("%s: Error: DDR adjust table invalid CRC eeprom=0x%08x, calculated=0x%08x, len=%d\n",
